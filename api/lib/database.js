...
con.connect(function (err) {
  ...
  let createUsersQuery =
    "DROP TABLE if exists users; CREATE TABLE users (id INT NOT NULL AUTO_INCREMENT, username VARCHAR(255) NOT NULL, password VARCHAR(10)NOT NULL, PRIMARY KEY (id));";
